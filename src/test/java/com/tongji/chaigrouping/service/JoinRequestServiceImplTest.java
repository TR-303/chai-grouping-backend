...
public class JoinRequestServiceImplTest {
    ...
    void setUp() {
        ...
        service.joinRequestMapper = joinRequestMapper;
        service.membershipMapper = membershipMapper;
        service.groupMapper = groupMapper;
        service.userMapper = userMapper;
        service.notificationListServiceImpl = notificationService;
    }
